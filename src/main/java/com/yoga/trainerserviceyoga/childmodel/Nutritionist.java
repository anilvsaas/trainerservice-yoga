...
public class Nutritionist {
	...
	public String getNutrionistFrom() {
		return nutrionistFrom;
	}

	public void setNutrionistFrom(String nutrionistFrom) {
		this.nutrionistFrom = nutrionistFrom;
	}
